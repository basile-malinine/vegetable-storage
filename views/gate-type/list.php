...
$this->registerJs('let controllerName = "gate-type";', \yii\web\View::POS_HEAD);
...
<div class="page-content">
    <div class="page-top-panel">
        <div class="page-top-panel-header d-flex">
            ...
            <a href="/gate-type/create" class="btn btn-light btn-outline-secondary btn-sm mt-1 ms-auto pe-3">
