...
$header = 'Статус Приёмка';

$this->registerJs('let controllerName = "acceptance-status";', \yii\web\View::POS_HEAD);
...
<div class="page-content">
    <div class="page-top-panel">
        <div class="page-top-panel-header d-flex">
            ...
            <a href="/acceptance-status/create" class="btn btn-light btn-outline-secondary btn-sm mt-1 ms-auto pe-3">
