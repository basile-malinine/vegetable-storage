...
$header = 'Статус Стикер';

$this->registerJs('let controllerName = "sticker-status";', \yii\web\View::POS_HEAD);
...
<div class="page-content">
    <div class="page-top-panel">
        <div class="page-top-panel-header d-flex">
            ...
            <a href="/sticker-status/create" class="btn btn-light btn-outline-secondary btn-sm mt-1 ms-auto pe-3">
