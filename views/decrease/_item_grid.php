...
<?php Pjax::begin(['id' => 'decrease-items']) ?>
<?= GridView::widget([
    'layout' => "{items}\n{pager}",
    'dataProvider' => $dataProviderItem,
    'rowOptions' => $model->date_close ? [] : function (DecreaseItem $model, $key, $index, $grid) {
        return [
            'class' => 'contextMenuRow',
            'data-row-id' => $model->decrease_id . '/' . $model->assortment_id,
        ];
    },
