...
$ids = ArrayHelper::getColumn($model->packing->sourceAcceptances, 'id');
...
$company_own_id = $model->packing->company_own_id;
$stock_id = $model->packing->stock_id;

$assortment = $model->packing->assortment;
...
<div class="page-content">
    <div class="page-content-form">
        ...
        <div class="form-group">
            ...
            <?= Html::a('Закрыть', '/packing/edit/' . $model->packing_id, [
