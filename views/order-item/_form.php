...
$assortmentList = [];
$ids = ArrayHelper::getColumn($model->order->items, 'assortment_id');
    ...
    <div class="page-content-form">
        ...
        <div class="row form-row">
                ...
                <?= $form->field($model, 'assortment_id')->widget(Select2::class, [
                    ...
                    'options' => [
                        ...
                        'onchange' => '
                            ...
                            const $weight = $("#order-item-weight");
                            $.post(
            ...
            <div class="form-col col-3">
                <?= Html::label('Ед. изм.', 'order-item-unit', ['class' => 'col-form-label pt-0']) ?>
                <?= Html::input('text', 'order-item-unit',
            ...
            <!-- Вес единицы -->
            <div class="form-col col-3">
                <?= Html::label('Вес единицы', 'order-item-weight', ['class' => 'col-form-label pt-0']) ?>
                <?= Html::input('text', 'order-item-weight',
                    Yii::$app->controller->action->id !== 'add'
        ...
        <div class="form-group">
            ...
            <?= Html::a('Закрыть', '/order/edit/' . $model->order_id, ['class' => 'btn btn-light btn-outline-secondary btn-sm']) ?>
        </div>
