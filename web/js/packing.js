                ...
                onClick: (id) => {
                    if (confirm("Вы точно хотите удалить запись?")) {
                        ...
                        $.post(
                            ...
                            (data) => {
                                $.pjax.reload({
                                    container: '#packing-item-grid',
                                    async: false
                                });
                                $.pjax.reload('#packing-qnt-weight-info');
                            }
                        );
                    }
                }
